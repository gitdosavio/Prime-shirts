...
<div class="container-fluid">
 <div class="row align-items-start">
    ...
    <div class="col">
      <br><br>
     <img href="#" src="imagens/c2.png" height="500" width="500" style="border: #000000 Solid 2px;">
    </div>
    <div class="col">
      <br><br>
  ...
  <thead>
    <tr>
      <th scope="col"></th>
      <th scope="col"></th>
      <th scope="col"><center>Camiseta Código PHP 2019</center></th>
      <th scope="col"></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <th scope="row"></th>
      <td></td>
      <td><center>Camiseta Código PHP 2019 de malha macia confeccionada em modelagem clássica. Despojada e divertida, a Camiseta Código PHP 2019 é ideal para te acompanhar durante o dia a dia de programação. Camiseta de manga curta. Confeccionada em algodão, possui tecido com toque macio e acabamento super confortável. Além da modelagem básica para atingir todos os gostos, a estampa em silk screen passa por um tratamento especial que traz suavidade no vestir.</center></td>
      <td></td>
    </tr>
    <tr>
      <th scope="row"></th>
      <td></td>
      <td><center>Preço: R$ 39,99</center></td>
      <td></td>
...
<br><br><br>
<center><button type="button" class="btn btn-outline-dark">COMPRAR</button></center>
  <br><br>
  <center><button type="button" class="btn btn-outline-dark">ADICIONAR AO CARRINHO</button></center>
    </div>
    <div class="col">
  ...
  <div class="row align-items-center">
    <div class="col">
      <br>
      <center><textarea  name="comentário" rows="3" cols="40">Escreva seu comentário....</textarea></center>
    </div>
    <div class="col">
  ...
  <div class="row align-items-end">
    <div class="col">
      <br>
    <center> <button type="button" class="btn btn-outline-dark">ENVIAR</button></center>
    </div>
    <div class="col">
