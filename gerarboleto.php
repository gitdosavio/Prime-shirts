...
<!-------------------------------- meio da página ------------------------------------------->
    <header>
        <center>
            <div class="col-4">
    <div class="p-1 mb-3 bg-secondary text-white">Preencha todos os dados</div>
        </div>
            </div>
        </center>
              </br></br>
  ...
  <div class="form-row">     
    ...
    <div class="form-group col-3"> 
      ...
      <input type="text" id="nome" class="form-control" placeholder="Digite aqui">
          ...
          <div class="form-group col-1"> 
              <label for="CPF">D. nascimento</label>
      <input type="text" id="CPF" class="form-control" placeholder="dd/mm/aa">
          </div>
        </div>         
          </div>  
...
<center>
    <button type="button" class="btn btn-success">Gerar boleto</button>
    </center>
</br></br></br>
