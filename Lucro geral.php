...
<nav class="navbar navbar-expand-lg navbar-light submenu">
  ...
  <div class="submenu collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
     	<li class="nav-item">
        <a class="nav-link" href="lucroi.php">Lucro Individual <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="navbar-brand" href="Lucro geral.php">Lucro Geral <span class="sr-only">(current)</span></a>
      </li>
    </ul>
  </div>
</nav>
...
<button type="button" class="btn btn-light" data-toggle="modal" data-target="#lucrog">
Camiseta mais vendida
</button>

<!-- Modal -->
<div class="modal fade" id="lucrog" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Camiseta mais vendida</h5>
