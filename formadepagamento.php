...
<!-------------------------------- meio da página ------------------------------------------->
    <header>
        <center>
            ...
            <div class="col-4">
    <div class="p-1 mb-3 bg-secondary text-white">Escolha a forma de pagamento</div>
        </div>
            </div>
        </center>
              </br></br>
    ...
    <div class="col-4"></div>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <div class="col-1">  <img src="imagens/boleto.jpg" height="40" width="65" style="border: #000000 Solid 2px;"></div>
          <div class="col-3"><input class="form-check-input" type="radio" name="exampleRadios"  id="exampleRadios1" value="option1" checked>
              <span> Pagamento por boleto bancário</span></div>
</div>
    </br>
          <div class="row">
    <div class="col-4"></div>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <div class="col-1">  <img src="imagens/cartao.jpg" height="40" width="65" style="border: #A4A4A4 Solid 2px;"></div>
          <div class="col-3"><input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
              <span> Pagamento por cartão de crédito</span></div>
 ...
 <!-- <div>
  ...
  <img src="imagens/boleto.jpg" height="50" width="75" style="border: #000000 Solid 2px;">
    <center> 
...
<div>
     <div class="col-9" align="center">
   <a href="#"><img src="imagens/cartao.jpg" height="50" width="75" style="border: #000000 Solid 2px;"></a>
    </div>
</div>
<center>
...
<center>
    <a href="dadosdocartao.php" ><button type="button" class="btn btn-success">Confirmar</button></a>
    </center>
</br></br></br>
