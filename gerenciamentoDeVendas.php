...
<!-------------------------------- meio da página ------------------------------------------->
    <header>
        ...
        <div class="container-fluid" style="height:90%">     
         <center>
          <div class="col-4">
           <div class="p-1 mb-3 bg-secondary text-white">Gerenciamento de vendas</div>
            </div>
              </center>
            </br>
            <center>         
            <div class="row">
                            <div class="col-1"></div>
                      <div class="bg-dark col-2 col-sm-2 text-white" >Código</div>
                      <div class="bg-dark col-2 col-sm-2 text-white">Descrição produto</div>
                    <div class="bg-dark col-2 col-sm-2 text-white">Unidade</div>
                      <div class="bg-dark col-2 col-sm-2 text-white">Valor unitário</div>
                                <div class="bg-dark col-2 col-sm-2 text-white">Valot total</div>
                                </div>
            
                            <div class="row">
                            <div class="col-1"></div>
                      <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;">432</div> 
                      <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;">Camiseta modelo t.a.d.s</div>
                    <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;">3 Uni.</div>
                      <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;">R$ 49,00</div>
                                <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;">R$ 147,00</div>
                               &nbsp;&nbsp;<a href="#"><img src="imagens/pranchetaOk.png" height="50" width="60"> </a>  
                                </div>
<div class="row">
                            <div class="col-1"></div>
                      <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;"> // </div>
                      <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;"> // </div>
                    <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;"> // </div>
                      <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;"> // </div>
                                <div class="col-2 col-sm-2" style="border: #000000 Solid 2px;"> // </div>
